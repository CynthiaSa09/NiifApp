...
class NewsHistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create news_history" do
    assert_difference('NewsHistory.count') do
      post news_histories_url, params: { news_history: { content: @news_history.content, title: @news_history.title } }
    end
  ...
  test "should update news_history" do
    patch news_history_url(@news_history), params: { news_history: { content: @news_history.content, title: @news_history.title } }
