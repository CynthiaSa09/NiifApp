...
niif.contents.create!(text: 'Si una entidad utiliza la exención del párrafo D8B para operaciones sujetas a regulación de tarifas, revelará ese hecho y la base sobre la que se determinaron los importes en libros conforme a los PCGA anteriores.', number: '31b', order: 57)

niif.contents.create!(text: 'Utilización del Costo como Atribuido Después de una Hiperinflación Grave', label: 5, order: 58)
...
(b) No existe intercambiabilidad entre la moneda y una moneda extranjera relativamente estable.', number: '31c', order: 59)
